module FourthDatabase

let subjs = [("LP","Логическое программирование");("MTH","Математический анализ");
             ("FP","Функциональное программирование");("INF","Информатика");
             ("ENG","Английский язык");("PSY","Психология")]
